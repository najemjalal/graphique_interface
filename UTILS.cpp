/*
UTILS.cpp - Class file for the utility Arduino Library.
...
/* Converts a value from BCD to decimal */
...
void ftoa(float f, char *str, uint8_t precision) {
  ...
  if ((log_f >= 0) and (log_f < precision)) {                 //if precision exceeds number of integer digits,
